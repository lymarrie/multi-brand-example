...
const BannerBrand2 = (props: BannerProps) => {
  const { name, address } = props;

  return (
    <>
      <div
        className={`relative z-10 w-full bg-cover bg-center h-96 bg-[url(/src/assets/images/banner.webp)] `}
        >
        <div className="absolute left-0 right-0 flex flex-col items-center">
          <div className="w-96 my-8 rounded-xl bg-primary border-8 shadow-xl border-amber-600 px-4 py-2 text-center">
            <div>
